...
@Component
public class DeleteUserRequestValidator implements Validator<DeleteUserRequest> {

  public void validate(DeleteUserRequest request) {

    Validate.notNull(request, "The DeleteUserRequest should not be null.");
