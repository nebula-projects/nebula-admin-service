...
package org.nebula.admin.service.exception;
...
public class AdminServiceExceptionHandler extends ResponseEntityExceptionHandler {
  ...
  private final static Logger logger = Logger.getLogger(AdminServiceExceptionHandler.class);
  ...
  protected ResponseEntity<Object> badRequest(IllegalArgumentException ex, WebRequest request) {
    ...
    ResponseEntity<Object> response = handleExceptionInternal(null, bodyOfResponse,
                                                              new HttpHeaders(),
